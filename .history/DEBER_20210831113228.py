...
#         self.bono=incentivos
    ...
    def mostrar(self):
        print("La empresa "{}"\n De RUC #{} \n Está ubicada en {}\n se puede comunicar al #{}, esta empresa esta en la ciudad de {}, y es una empresa tipo {}".format(self.nombre,self.ruc,self.direccion, self.telefono,self.ciudad, self.tipoEmpresa))

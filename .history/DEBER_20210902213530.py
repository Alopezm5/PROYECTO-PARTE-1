class Nomina: 
    def __init__(self,nom="",ruc=0,dire="",tele=0,ciud="",tipEmpr="",email="",estado="",profe="",dep="", valhora=0,hotraba=0, desc=0, desper=0):#3
        self.nombre=nom
        self.ruc=ruc
        self.direccion=dire
        self.telefono=tele
...
class Empresa(Nomina):
    ...
    def mostrarEmpresa(self):
        ...
        print("La empresa "{}"\n De RUC #{} \n Está ubicada en {}\n Se puede comunicar al #{}\n Está empresa esta en la ciudad de "{}"\n Es una entidad "{}"".format(self.nomr,self.ruc,self.direccion, self.telefono,self.ciudad, self.tipoEmpresa))

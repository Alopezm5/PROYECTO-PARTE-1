...
class Empresa(Nomina):
    ...
    def mostrarEmpresa(self):
        print("La empresa {}"\n "con #{} de ruc, esta ubicada en {}, se puede comunicar al #{}, esta empresa esta en la ciudad de {}, y es una empresa tipo {}".format(self.nombre,self.ruc,self.direccion, self.telefono,self.ciudad, self.tipoEmpresa))

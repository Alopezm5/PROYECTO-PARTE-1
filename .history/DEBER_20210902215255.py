class Nomina: 
    def __init__(self,,,,dep="", valhora=0,hotraba=0)
...
class Departamento(Empleado):
    def __init__(self, nom, ruc, dire, tele, email, estado, profe):
        super().__init__(nom=nom, ruc=ruc, dire=dire, tele=tele, email=email, es
    def departa(self):

...
class Empleado(Empresa):
    ...
    def mostrarempleado(self):
        ...
        print("El empleado tiene una profesion de {}\n con un estado civil {}".format(self.profesion,self.es))
...
class Pagos(Empleado):
    ...
    def mostrarSueldo(self):
        ...
        print("")
        print("SOBRETIEMPO")
        print("El valor de sobretiempo es de {}\n, Con {} horas extras trabajadas".format(self.sobretiempo,self.horasExtraordinarias))
        print("")
        print("PRESTAMO")
        print("El valor de prestamo es de {}\n, A ser pagado en {} meses\n, Con cuotas de ${}".format(self.prestamo,self.mesCuota,self.cuotaPrestamo))
        print("")
        print("Dando asi valores finales de ${}, ${}, ${} ".format(self.toting,self.totdes,self.liquidoRecibir))

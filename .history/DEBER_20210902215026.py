class Nomina: 
    def __init__(self,,email="",estado="",profe="",dep="", valhora=0,hotraba=0):#
        self.correo=email
...
class Empleado(Empresa):
    def __init__(self, nom, ruc, dire, tele, ciud, tipEmpr):
        super().__init__(nom=nom, ruc=ruc, dire=dire, tele=tele, ciud=ciud, tipEmpr=tipEmp
    def empleado(self):

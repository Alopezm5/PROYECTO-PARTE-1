...
class Empleado(Empresa):
    def __init__(self,nom="",cedu=0,dire="",tele=0,email="",estado="",profe="",anti=0,,fNomina="",fIngreso="",iess=0):
        self.nombre=nom
        self.cedula=cedu
        self.direccion=dire
        self.telefono=tele
...
class Pagos(Empleado):
    def __init__(self, desper=0,valhora=0,hotraba=0,extra=0,suel=0,hrecar=0,hextra=0,pres=0,mcou=0,valho=0,sobtiem=0,comofi=0,antobre=0,iemple=0,cuopres=0,tot=0,liquid=0,cuota=0,anti=0):
    ...
    def pagoNormal(self):
        ...
        self.mesCuota=int(input("Ingresar meses a diferir el prestamo: ")self.comision=float(input("Ingresar valor de la comsion: "))
